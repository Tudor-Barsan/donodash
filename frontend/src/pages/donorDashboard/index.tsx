            ...
            <div className="flex-grow overflow-y-auto flex flex-wrap flex-col" >
                ...
                <div className="flex">
                    ...
                    <List>
                        <ListItem>
                        <ListItemPrefix>
                            <Avatar variant="circular" alt="candice" src="/charityImages/booksforall.jpeg" />
                        </ListItemPrefix>
                        <div>
                        ...
                        <ListItem>
                        <ListItemPrefix>
                            <Avatar variant="circular" alt="alexander" src="/charityImages/greenearth.jpeg" />
                        </ListItemPrefix>
                        <div>
                            <Typography variant="h6" color="blue-gray">
                        ...
                        <ListItem>
                        <ListItemPrefix>
                            <Avatar variant="circular" alt="emma" src="/charityImages/feedthefuture.jpeg" />
                        </ListItemPrefix>
                        <div>
                            <Typography variant="h6" color="blue-gray">
                            Feed the Future
